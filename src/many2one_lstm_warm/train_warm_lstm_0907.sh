...
cd /home-nfs/ttran/transitory/speech-nlp/venv_projects/seq2seq_parser/many2one_lstm_warm

TRAIN_DIR="/home-nfs/ttran/transitory/speech-nlp/venv_projects/seq2seq_parser/tmp_results/model-lstm-warm-0907"
