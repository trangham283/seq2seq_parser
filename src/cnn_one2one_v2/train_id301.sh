...
LD_PRELOAD="/home-nfs/ttran/sw/opt/lib/libtcmalloc.so" python train_model.py -run_id 301 -use_speech -text_num_layers 3 -parse_num_layers 3 -use_conv -data_dir $DATA_DIR -tb_dir $MODEL_DIR -num_filters 128 -filter_sizes 5-15-25-40-50 -max_epochs 100 >> $MODEL_DIR/output.id301_withenergy.txt
