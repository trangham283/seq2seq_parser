...
LD_PRELOAD="/home-nfs/ttran/sw/opt/lib/libtcmalloc.so" python train_model.py -run_id 1100 -use_pause -psize 4 -use_conv -data_dir $DATA_DIR -tb_dir $MODEL_DIR -bm_dir $BEST_DIR -max_epochs 100 >> $MODEL_DIR/output.id1100.txt
