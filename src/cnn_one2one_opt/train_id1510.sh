...
LD_PRELOAD="/home-nfs/ttran/sw/opt/lib/libtcmalloc.so" python train_model.py -run_id 1510 -use_pause -psize 16 -use_speech -num_filters 64 -filter_sizes 10-25-50 -use_conv -data_dir $DATA_DIR -tb_dir $MODEL_DIR -bm_dir $BEST_DIR -max_epochs 100 >> $MODEL_DIR/output.id1510.txt
