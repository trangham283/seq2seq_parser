...
model_dir=/home-nfs/ttran/transitory/speech-nlp/venv_projects/seq2seq_parser/many2one_extra/models
id_dir=lr_0.001_bsize_64_esize_512_text_hsize_500_text_num_layers_2_speech_hsize_500_speech_num_layers_${speech_num_layers}_parse_hsize_500_parse_num_layers_2_attn_vec_size_64_sp_scale_5_out_prob_${out_prob}_run_id_${id}${opt}rnn_lstm_many2one_speech
