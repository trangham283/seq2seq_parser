...
cd /home-nfs/ttran/transitory/speech-nlp/venv_projects/seq2seq_parser/many2one_lstm_base

TRAIN_DIR="/home-nfs/ttran/transitory/speech-nlp/venv_projects/seq2seq_parser/tmp_results/model-lstm-base-0907"
...
LD_PRELOAD="/home-nfs/ttran/sw/opt/lib/libtcmalloc.so" python train_many2one.py \
    ...
    --batch_size=64 \
    --dropout \
    --max_steps=80000 >> output_lstm_base_0907.txt
deactivate
