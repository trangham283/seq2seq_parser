...
tf.app.flags.DEFINE_string("warm_path", "/share/data/speech/Data/ttran/speech-nlp/venv_projects/seq2seq_parser/t2p_dropout/variables-step160000.pickle", "path to model for warm start")
    ...
    if FLAGS.warm_start:
        ...
        for v in my_variables:
          ...
          if v_warm in saved_variables:
            ...
            if "AttnOutputProjection" in v.name: continue # don't want to reuse this
