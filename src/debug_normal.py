...
tf.app.flags.DEFINE_integer("max_steps", 20, "max number of steps, in terms of batch passes.")
...
def create_model(session, forward_only, attention=True, model_path=None):
...
#      model_dev = local_seq2seq_model.Seq2SeqModel(
#      FLAGS.input_vocab_size, FLAGS.output_vocab_size, _buckets,
#      FLAGS.hidden_size, FLAGS.num_layers, FLAGS.embedding_size,
#      FLAGS.max_gradient_norm, FLAGS.batch_size,
#      FLAGS.learning_rate, FLAGS.learning_rate_decay_factor,
#      forward_only=True, attention=True)      
    ...
    while current_step <= num_remaining_steps:
        ...
        encoder_inputs, decoder_inputs, target_weights = model.get_mix_batch(
